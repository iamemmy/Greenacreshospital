...
import Service2 from '../assets/img8.png';
      ...
      <div className='services-bottom'>
        ...
        <div className='service-card'>
          ...
          <div className='service-card-bottom'>
            ...
            <p>
              we offer a thorough physical examination; including  variety of tests depending on the age 
              and sex and health of the person.
            </p>
          </div>
        </div>
      </div>
